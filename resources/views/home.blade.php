...
<div class="container">
    ...
    <transition enter-active-class="fadeIn" leave-active-class="fadeOut" :duration="300">
        <div ref="PostEditorContainer" class="editor-container animated" v-show="activePost">
            <post-editor-desktop v-if="activePost && device === 'desktop'" :post="activePost" @close="closeEditor"></post-editor-desktop>
            <post-editor-mobile v-if="activePost && device === 'mobile'" :post="activePost" @close="closeEditor"></post-editor-mobile>
        </div>
    </transition>
</div>
@endsection
